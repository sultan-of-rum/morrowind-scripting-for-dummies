...
\index{GetPlayerControlsDisabled}
\index{GetPlayerFightingDisabled}
\index{GetPlayerJumpingDisabled}
\index{GetPlayerLookingDisabled}
\index{GetPlayerMagicDisabled}
\index{GetPlayerViewSwitch}
...
\index{EnableBirthMenu}
\index{EnableClassMenu}
\index{EnableRaceMenu}
\index{EnableNameMenu}
...
\index{EnableMagicMenu}
\index{EnableMapMenu}
\index{EnableInventoryMenu}
\index{EnableStatsMenu}
