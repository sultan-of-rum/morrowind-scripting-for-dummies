...
\begin{lstlisting}	
	Actor-> AddItem, "item\_ID", 1
	
	Container-> RemoveItem, "itme\_ID", 5
\end{lstlisting}
...
\begin{lstlisting}
	...
	player-> RemoveItem, "ingred\_dreugh\_wax\_01", 1
	
	"\_tm\_ingredients\_chest"-> AddItem,
...
\begin{lstlisting}	
	...
	Set objectcount to ( "Mob\_ID"-> GetItemCount, "Object\_ID" )
	
	If ( GetItemCount, "Object\_ID" >= 1 )
\end{lstlisting}
...
\begin{lstlisting}	
	if ( "daedric\_mace"-> RepairedOnMe, "repair\_journeyman\_01"
	== 1 )
\end{lstlisting}
...
\begin{lstlisting}	
	...
	"Actor\_ID"-> PositionCell, -254, 475, -376, 360, "Balmora,
	Council Club"
\end{lstlisting}
...
\begin{lstlisting}
	Object-> PlaceAtMe `Item\_ID' count\_enum distance\_enum
	direction\_enum
\end{lstlisting}
...
\begin{lstlisting}
	...
	"active\_BM\_hunter1"->\textbf{PlaceAtMe} skaal\_hunter 1 1
	1
	...
	"active\_BM\_hunter2"->\textbf{PlaceAtMe} skaal\_hunter 1 1
	1
	...
	"active\_BM\_hunter3"->\textbf{PlaceAtMe} skaal\_hunter 1 1
	1
...
\begin{lstlisting}
	...
	if ( \textbf{GetDistance} "guar\_white\_unique" <= 256 )
	
	if ( GetJournalIndex "MS\_WhiteGuar" <= 50 )
...
\begin{lstlisting}
	...
	Object\_ID-> HurtStandingActor 1
...
\begin{lstlisting}
	...
	Object\_ID-> HurtCollidingActor, 100
\end{lstlisting}
